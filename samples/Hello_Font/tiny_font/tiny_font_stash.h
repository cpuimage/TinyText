...
#ifndef TINY_FONTSTASH_H
#define TINY_FONTSTASH_H
...
struct RenderCallbacks {
    ...
    virtual void set_color_rgba(float color[4]) = 0;

    virtual void set_world_position(float pos[3]) = 0;

    virtual void set_world_orientation(float orn[4]) = 0;
...
inline void sth_draw_text(struct sth_stash *stash, int idx, float size, float x,
                          ...
                          int measureOnly = false, float retinaScale = 1.f) {
