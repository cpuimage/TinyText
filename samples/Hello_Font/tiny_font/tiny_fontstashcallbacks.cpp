...
OpenGLRenderCallbacks::OpenGLRenderCallbacks(
        TinyGLPrimitiveRenderer *primRender)
        : m_primRender2(primRender) {}

OpenGLRenderCallbacks::~OpenGLRenderCallbacks() {}

PrimInternalData *OpenGLRenderCallbacks::getData() {
    return m_primRender2->get_data();
}

InternalOpenGLRenderCallbacks::~InternalOpenGLRenderCallbacks() {}

void InternalOpenGLRenderCallbacks::display2() {
...
void InternalOpenGLRenderCallbacks::update_texture(sth_texture *texture,
                                                   sth_glyph *glyph,
                                                   int textureWidth,
                                                   int textureHeight) {
    assert(glGetError() == GL_NO_ERROR);
...
void InternalOpenGLRenderCallbacks::render(sth_texture *texture) {
    display2();
