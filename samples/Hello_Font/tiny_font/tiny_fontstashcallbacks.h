...
struct InternalOpenGLRenderCallbacks : public RenderCallbacks {
    virtual PrimInternalData *getData() = 0;

    virtual ~InternalOpenGLRenderCallbacks();
...
struct SimpleOpenGL2RenderCallbacks : public InternalOpenGLRenderCallbacks {
...
struct OpenGLRenderCallbacks : public InternalOpenGLRenderCallbacks {
    ...
    OpenGLRenderCallbacks(TinyGLPrimitiveRenderer *primRender);

    virtual ~OpenGLRenderCallbacks();
};
